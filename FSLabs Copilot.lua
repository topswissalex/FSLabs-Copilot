...
local logFile = "FSLabs Copilot\\FSLabs Copilot.log"
...
function restingLoop() sleep(1000) end
function criticalLoop() sleep(100) end
...
if enable_actions == 1 then
   ipc.set("FSLC_SOP", SOP)
   ipc.set("FSLC_PM", PM)
   ipc.set("FSLC_after_start", after_start)
   ipc.set("FSLC_lineup", lineup)
   ipc.set("FSLC_after_takeoff", after_takeoff)
   ipc.set("FSLC_landing", landing)
   ipc.set("FSLC_packs_on_takeoff", packs_on_takeoff)
   ipc.set("FSLC_pack2_off_after_landing", FSLC_pack2_off_after_landing)
   ipc.runlua("FSLC_SOP_launcher")
end
